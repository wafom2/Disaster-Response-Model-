...
.
âââ app
âÂ Â  âââ run.py------------------------# FLASK FILE THAT RUNS APP
âÂ Â  âââ static
âÂ Â  âÂ Â  âââ favicon.ico---------------# FAVICON FOR THE WEB APP
âÂ Â  âââ templates
âÂ Â      âââ go.html-------------------# CLASSIFICATION RESULT PAGE OF WEB APP
âÂ Â      âââ master.html---------------# MAIN PAGE OF WEB APP
âââ data
âÂ Â  âââ DisasterResponse.db-----------# DATABASE TO SAVE CLEANED DATA TO
âÂ Â  âââ disaster_categories.csv-------# DATA TO PROCESS
âÂ Â  âââ disaster_messages.csv---------# DATA TO PROCESS
âÂ Â  âââ process_data.py---------------# PERFORMS ETL PROCESS
âââ img-------------------------------# PLOTS FOR USE IN README AND THE WEB APP
âââ models
